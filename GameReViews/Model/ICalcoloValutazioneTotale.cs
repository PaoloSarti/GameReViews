...
namespace GameReViews.Model
{
    ...
    class CalcoloValutazionePersonalizzata : ICalcoloValutazioneTotale
    {
        ...
        public CalcoloValutazionePersonalizzata(UtenteRegistrato utente)
        {
            ...
            if (utente == null||utente.PreferenzeList==null)
        ...
        {
            #region Precondizioni
            if (recensione == null || recensione.AspettiValutatiList== null)
            ...
            foreach(AspettoValore aspettoValutato in recensione.AspettiValutatiList)
            {
                foreach(AspettoValore preferenza in _utente.PreferenzeList)
                {
    ...
    class CalcoloValutazioneNonPersonalizzata : ICalcoloValutazioneTotale
    {
        ...
        public float Calcola(Recensione recensione)
        {
            ...
            IEnumerable<int> valutazioni = from aspettoValutato in recensione.AspettiValutatiList select aspettoValutato.Valore;
